/* JIFU_TRUE_FINAL_FIXED_TODAY_20260527 */
(function(){
  'use strict';
  ...
  async function drawContact(ctx){
    ...
    // 小框：QR，位於形象照左下，與形象照底部對齊。
    var qrSize = 90;
    var qrX = 1180;
    var qrY = photoY + photoH - qrSize;
